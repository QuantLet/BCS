...
plot(z, dstable(z, alpha[1], beta, sigma, mu, 1), type = 'l',
     xlim = c(-5, 5), ylim = c(0, 0.5), xlab = "z", ylab = "pdf")  
...
plot(z, dstable(z, alpha, beta[1], sigma, mu, 1), col = "red",     
     type = 'l', xlim = c(-5, 5), ylim = c(0, 0.35),
     xlab = "z", ylab = "pdf")                                         
...
plot(z, pstable(z, alpha[1], beta, sigma, mu, 1), type = 'l',
     xlim = c(-5, 5), ylim = c(0, 1), xlab = "z", ylab = "cdf")      
...
plot(z, pstable(z, alpha, beta[1], sigma, mu, 1), col = "red",
     type = 'l', xlim = c(-5, 5), 
     ylim = c(0, 1), xlab = "z", ylab = "cdf")                    
